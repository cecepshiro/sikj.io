...
<head>
    ...
    <title>Data Pegawai | Hospital App</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            @if(Auth::user()->hak_akses==0)
                            <div>
                                <a href="{{ route('pegawai.create') }}" class="btn bg-green btn-md waves-effect">
                                <i class="material-icons"></i>Tambah Pegawai</a>
                            </div>
                            <br>
                            @endif
                                <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                              							<a href="{{ route('pegawai.edit', ['pegawai'=>$d->nip]) }}" class="btn bg-orange btn-xs waves-effect">
                                              <i class="material-icons">mode_edit</i>
                              							</a>
