...
<head>
    ...
    <title>Dashboard Admin | Hospital App</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                     <div class="card">
                        ...
                        @endif
                           Selamat datang di sistem informasi kateterisasi jantung. Anda login sebagai admin dengan username {{ Auth::user()->name }}
                        </div>
                    </div>
                </div>
            </div>
