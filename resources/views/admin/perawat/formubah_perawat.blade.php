            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
						            <form method="POST" action="{{ route('perawat.update', ['perawat'=> $data['id_perawat']]) }}" enctype="multipart/form-data">
                        ...
                        {{ csrf_field() }}
                            <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="email_address_2" class="form-control" name="id_perawat" value="{{ $data->id_perawat }}"readonly placeholder="Enter your name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="email_address_2" class="form-control" name="nama_perawat"  value="{{ $data->nama_perawat }}" placeholder="Enter your name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="no_telp" id="email_address_2"  value="{{ $data->no_telp }}" class="form-control" placeholder="Enter your name">
												                        <input type="text" name="id" id="email_address_2" class="form-control" placeholder="ID Perawat" value="{{ Auth::user()->id }}">
                            ...
                            <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4">
                                       ...
                                       <a href="{{ route('perawat.index') }}" type="button" class="btn btn-danger waves-effect">BATAL</button></a>
                                    </div>
                                </div>
                        </div>
