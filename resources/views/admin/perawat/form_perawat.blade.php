            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <form method="POST" action="{{ route('perawat.store') }}" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="row clearfix">
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama_perawat" class="form-control" placeholder="Enter your name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                               ...
                               <input name="group1" type="radio" class="with-gap" id="radio_3" />
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                    <textarea rows="4" class="form-control no-resize auto-growth" name="alamat" placeholder="Alamat lengkap..."></textarea>
                                </div>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" maxlength="12" name="no_telp" class="form-control" placeholder="Enter Phone Number">
