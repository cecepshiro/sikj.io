...
<head>
    ...
    <title>Form Data Status Pegawai</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <form method="POST" action="{{ route('statuspegawai.update', ['statuspegawai'=> $data['id_status']]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="id_status" value="{{ $data->id_status }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
