...
<head>
    ...
    <title>Form Data Diagnosa</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <form method="POST" action="{{ route('diagnosa.store') }}" enctype="multipart/form-data">
                          {{ csrf_field() }}
                          <?php
                          $kode = Auth::user()->id;
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4">
                                      ...
                                      <a href="{{ route('diagnosa.show',['diagnosa'=>$cari]) }}" type="button" class="btn btn-danger waves-effect">BATAL</button></a>
                                   </div>
                                </div>
                        </form>
                        </div>
