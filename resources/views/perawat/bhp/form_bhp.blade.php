...
<head>
    ...
    <title>Form Pengajuan BHP</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form method="POST" action="{{ route('masterpengajuan.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <?php
                            $kode= Auth::user()->id;
                            $tmp=DB::table('data_perawat')->select('id_perawat')->where('id', $kode)->value('id_perawat');
                            $tmp2=DB::table('data_perawat')->select('nama_perawat')->where('id', $kode)->value('nama_perawat');
                        ?>
                            <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="id_perawat" class="form-control" readonly value="{{ $tmp }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama_perawat" class="form-control" readonly value="{{ $tmp2 }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
