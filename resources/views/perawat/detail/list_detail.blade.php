...
<head>
    ...
    <title>Data Detail Pengajuan | Hospital App</title>
                        ...
                        <div class="body">
                            ...
                            <div>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                    ...
                                    @forelse($data as $d)
                                        <tr>
                                            <td>{{ $d->id_detail_pengajuan }}</td>
                                            <td>{{ $d->no_pengajuan }}</td>
                                            <td>{{ $d->bhp }}</td>
                                            <td>{{ $d->status }}</td>
                                            @if((Auth::user()->hak_akses)==2)
                                            <td>
                                            <form action="{{ route('detailpengajuan.destroy', ['detailpengajuan'=>$d->id_detail_pengajuan]) }}" method="post">
                              				<div class="form-group">
                                            <a href="{{ route('detailpengajuan.edit', ['detailpengajuan'=>$d->id_detail_pengajuan]) }}" class="btn bg-orange btn-xs waves-effect">
                                            <i class="material-icons">mode_edit</i>
                              				</a>
                                            ...
                                            <td>
                                            <form method="POST" action="{{ route('detailpengajuan.update', ['detailpengajuan'=> $d->id_detail_pengajuan]) }}" enctype="multipart/form-data">
                                            <input type="hidden" name="_method" value="PATCH">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="status" value="Accept">
                                            <input type="hidden" name="no_pengajuan" value="{{ $d->no_pengajuan }}">
                                            <input type="submit" class="btn btn-xs bg-blue waves-effect" value="Acc">
                                            </form>
                                            <form method="POST" action="{{ route('detailpengajuan.update', ['detailpengajuan'=> $d->id_detail_pengajuan]) }}" enctype="multipart/form-data">
                                            <input type="hidden" name="_method" value="PATCH">
                                            {{ csrf_field() }}
                                            ...
                                            <input type="hidden" name="no_pengajuan" value="{{ $d->no_pengajuan }}">
                                            <input type="submit" class="btn btn-xs bg-red waves-effect" value="Reject">
                                            </form>
                                            </td>
                                            @endif
                                        </tr>
