                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="email_address_2" class="form-control" name="nama_pasien" placeholder="Enter your name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                              ...
                                              ?>
												...
												<input type="hidden" name="nip" id="email_address_2" class="form-control" placeholder="ID Pendaftar" value="{{ $nip }}" readonly>
